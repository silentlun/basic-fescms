...
class Util
{
    public static function thumb($imgUrl, $width = 100, $height = 100 ,$autocut = 0, $smallpic = 'nopic.jpg')
    {
        $uploadUrl = Yii::$app->config->site_upload_url;
        $uploadPath = Yii::getAlias('@uploads/');
        
        if(empty($imgUrl)) return Yii::getAlias('@web/').'static/images/nopic.png';;
    ...
    {
        $templateDir = Yii::getAlias('@app/views/content/');
